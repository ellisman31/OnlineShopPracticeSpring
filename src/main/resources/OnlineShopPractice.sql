...
DROP TABLE IF EXISTS online_shop_address CASCADE;
CREATE TABLE online_shop_address (
	id bigint GENERATED BY DEFAULT AS IDENTITY,
	...
	online_shop_user_id bigint NOT NULL,
...
ALTER TABLE online_shop_user ADD CONSTRAINT online_shop_user_address
	...
	REFERENCES online_shop_address (id);
	
ALTER TABLE online_shop_address ADD CONSTRAINT online_shop_address_user
	FOREIGN KEY (online_shop_user_id)
	REFERENCES online_shop_user (id);
...
ALTER TABLE online_shop_cart ADD CONSTRAINT online_shop_cart_user
	FOREIGN KEY (online_shop_user_id)
	REFERENCES online_shop_user (id);
...
ALTER TABLE online_shop_product ADD CONSTRAINT online_shop_product_cart
	FOREIGN KEY (online_shop_cart_id)
	REFERENCES online_shop_cart (id);
...
INSERT INTO online_shop_product VALUES (1, 'TEST PRODUCT', 330, 1, '', 1);
INSERT INTO online_shop_user VALUES (1, 'FIRST NAME', 'LAST NAME', 'test@test.com', 'password', 1, 1);
INSERT INTO online_shop_address VALUES (1, 'CITY', 1111, 'STREET NAME', 'STREET_NUMBER', '', 1);

UPDATE online_shop_user
SET online_shop_address_id = 1;

UPDATE online_shop_cart
SET online_shop_user_id = 1, online_shop_product_id = 1;